...
借鉴 MaiBot 的 expression_learner / expression_selector：抽象的风格描述
（「说得自然一点」「句子长短不齐」）模型其实很难落地，真正管用的是
「在什么情境下、她大概会怎么说」这种具体样本。MaiBot 从真实群聊里学
这些样本，我们这里先用手写种子库，并且按当前这句话的情境挑几条注入，
