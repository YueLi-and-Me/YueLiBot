...
EVENT_LABELS: Dict[str, str] = {
    ...
    "memory_fact_invalidated": "记忆事实已标失效",
    "memory_fact_restored": "记忆事实已恢复",
    "memory_fact_pinned": "记忆事实已永久保留",
    "memory_fact_unpinned": "记忆事实已取消永久保留",
    "memory_fact_replaced": "记忆事实已人工取代",
    "memory_conflict_resolved": "记忆冲突已裁决",
    "memory_operation_undone": "记忆操作已撤销",
    "retrieval_profile_applied": "检索调优 profile 已生效",
    "retrieval_eval_done": "检索评估完成",
    "runtime_self_check_failed": "运行时自检发现问题",
    "runtime_self_check_passed": "运行时自检通过",
    "runtime_profile_install_id_created": "已生成随机安装 ID",
    "runtime_profile_launch_recorded": "已记录本次启动",
    "runtime_profile_runtime_flushed": "运行时长已落库",
    "runtime_profile_heartbeat_failed": "运行画像心跳落库失败",
    "stat_command_deferred": "统计命令暂缓注册",
    "stat_command_registered": "统计命令已注册",
    "stat_command_register_failed": "统计命令注册失败",
    "import_started": "导入开始",
    "import_done": "导入完成",
    "import_failed": "导入失败",
    "import_batch_deleted": "导入批次已删除",
