...
MODULE_COLORS: Dict[str, Tuple[str, bool]] = {
    ...
    "services.edge_decay": ("#87d7af", False),
    "agent.jargon_mine": ("#5fd787", False),
    "services.jargon_learn": ("#d7ff5f", True),
    "services.memory_feedback": ("#afd7ff", False),
...
MODULE_ALIASES: Dict[str, str] = {
    ...
    "services.edge_decay": "联想边衰减",
    "agent.jargon_mine": "黑话挖掘",
    "services.jargon_learn": "黑话学习",
    "services.memory_feedback": "记忆反馈",
    "schedule.plan": "生活方向",
