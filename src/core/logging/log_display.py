...
EVENT_LABELS: Dict[str, str] = {
    ...
    "chat_video_description": "聊天视频理解完成",
    "chat_video_too_long": "聊天视频超出观看时长上限",
    "chat_video_deferred": "聊天视频按范围暂不看",
    "chat_video_duration_unreadable": "聊天视频时长读不出",
    "chat_video_description_failed": "聊天视频理解失败",
    "chat_video_description_timeout": "聊天视频理解超时",
