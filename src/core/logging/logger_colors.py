...
MODULE_COLORS: Dict[str, Tuple[str, bool]] = {
    ...
    "runtime.update_notes": ("#ffd75f", True),
    "services.update_announce": ("#ffd75f", True),
    ...
    "services.media.chat_video": ("#5fd7d7", True),
...
MODULE_ALIASES: Dict[str, str] = {
    ...
    "runtime.update_notes": "版本更新",
    "services.update_announce": "发布公告",
    "config.loader": "配置加载",
    ...
    "services.media.chat_video": "聊天视频",
