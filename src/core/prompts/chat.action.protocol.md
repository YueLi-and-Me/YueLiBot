...
# 格式一：reply（回复）
<decision action="reply" targets="{{example_target_id}}" reasons="direct_question" length="brief"/>
<say emotion="normal">我现在有空，你说。</say>
...
决定动作头之后，再自然组织台词；标签只是外壳，不要为了填标签改掉你本来想说的那句话。
